<div class="col-md-3 s-d">
	  <div class="w_sidebar">
		...
		<h3 style="padding: 20px;font-weight: 700;">Фильтры поиска</h3>
						...
						<div class="row1 scroll-pane">
							<div class="col col-4">
								...
								$checked=0;
									...
									?>
									<label class="checkbox"><input type="checkbox" name="checkbox" <?php if($checked==1)echo "checked";?> id="<?php echo $newgetSubCategories['id'];?>"><i></i><?php echo $newgetSubCategories['name'];?></label>
