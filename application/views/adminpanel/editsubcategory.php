...
<?php 
	...
	echo form_open_multipart('subcategories/editSubCategory/',$attributes); 
...
<select name="category" class="form-control">
	<?php
		...
		<option value="<?php echo $newcategories["id"];?>" 
			<?php if($CAT == $newcategories["id"]){echo "selected";}?>>
			 <?php echo $newcategories["name"];?>
		</option>
	<?php endforeach; ?>
</select>
